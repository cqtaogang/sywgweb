...
enum WhichView {
	MAIN_MENU, DENGLU_VIEW, BOOKMAIN_VIEW, BOOKMANAGEMENT_INSERTVIEW, BOOKMANAGEMENT_INSERTVIEW_XIANSHI, BOOKMANAGEMENT_SELECT, BOOKMANAGEMENT_MODIFY, BOOKMANAGERMENT_DELETE, STUMAIN_VIEW, STUADD_VIEW, STUSELECT_VIEW, STUMOFIDY_VIEW, ADMINMAIN_VIEW, ADMINSELECT_VIEW, ADMINMOFIDY_VIEW, FEE_VIEW, ADMINADD_VIEW, HELP_VIEW, ABOUT_VIEW, LOSE_DETAILS_VIEW, LOSE_INFO_VIEW, LOSE_VIEW, QUERYMAIN_VIEW, SELF_VIEW_INFO, QUERY_VIEW, GIRD_VIEW, DETIALSVIEW, FEE_DRTILED, FEE_XIANSHI, YUYUE_VIEW, YUYUEDETAILED_VIEW
}
...
public class RootActivity extends Activity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		MenuItem help = menu
				.add(MAIN_GROUP, MENU_GENDER_HELP, 0, R.string.help);
		...
		MenuItem about = menu.add(MAIN_GROUP, MENU_GENDER_ABOUT, 0,
				R.string.about);
		...
		case DATE_INPUT_DIALOG_ID:
			...
			bsure.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// 年
					EditText eyear = (EditText) dateInputdialog
							.findViewById(R.id.EditText01);
					String syear = eyear.getText().toString();
					// 月
					EditText emonth = (EditText) dateInputdialog
							.findViewById(R.id.EditText02);
					String smonth = emonth.getText().toString();
					// 日
					EditText edate = (EditText) dateInputdialog
							.findViewById(R.id.EditText03);
					String sdate = edate.getText().toString();
					// 总的
					String str = DateUtil.getdate(syear, smonth, sdate,
							YEAR_INTERVAL); // 验证日期格式并返回
					// 弹出Toast
					// hgfddsdsssssss
					if (str == null) {
						switch (DateUtil.ERROR_MSG_INT) {
						case 0:
							Toast.makeText(RootActivity.this, "年份太久远",
									Toast.LENGTH_LONG).show();
							break;
						case 1:
							Toast.makeText(RootActivity.this, "二月的天数不对",
									Toast.LENGTH_LONG).show();
							break;
						case 2:
							Toast.makeText(RootActivity.this, "出错",
									Toast.LENGTH_LONG).show();
							break;
						case 3:
							Toast.makeText(RootActivity.this,
									"年份或月份或日期格式不对！请您检查清楚！", Toast.LENGTH_LONG)
									.show();
							break;
						}
					}
			...
			Button bcancel = (Button) dateInputdialog
					.findViewById(R.id.Button02); // 返回按钮监听
	...
	// 向上或向下按键
	public void UpOrDownDateTime(ImageButton button, final EditText et,
			final int uptime) {
	...
	public void gotoloseView() {
		...
		final EditText tvXH = (EditText) RootActivity.this
				.findViewById(R.id.loseXH);
		final Button loseButtonOk = (Button) RootActivity.this
				.findViewById(R.id.losebok);
		final Button loseButtonRe = (Button) RootActivity.this
				.findViewById(R.id.loseresert);
		// 为后退按钮添加监听
		ImageButton imagelose = (ImageButton) RootActivity.this
				.findViewById(R.id.ImageButtonlose);
		imagelose.setOnClickListener(new OnClickListener() {
		...
		// 重置按钮的设置监听
		loseButtonRe.setOnClickListener(new OnClickListener() {
		...
		loseInfo.clear();
		// 挂失按钮的设置监听
		loseButtonOk.setOnClickListener(new OnClickListener() {
	...
	public void gotoloseinfoView() {
		...
		GridView gvlose = (GridView) RootActivity.this
				.findViewById(R.id.GridViewlose01);
		ImageButton imagelose = (ImageButton) RootActivity.this
				.findViewById(R.id.ImageButton_loseinfo1);
		imagelose.setOnClickListener(new OnClickListener() {
		...
		SimpleAdapter sca = new SimpleAdapter(this,
				...
				new int[] { R.id.loseTextViewbooknumber,
						R.id.loseTextViewbookisbn, R.id.loseTextViewbookname,
						R.id.loseTextViewbookauthor, R.id.loseTextViewpress }// 列对应控件id列表
		);

		gvlose.setAdapter(sca);// 为GridView设置数据适配器
		// 设置选项选中的监听器
		gvlose.setOnItemSelectedListener(new OnItemSelectedListener() {
			@Override
		...
		// 设置选项被单击的监听器
		gvlose.setOnItemClickListener(new OnItemClickListener() {
			@Override
		...
		// 为后退的按钮添加监听
		ImageButton imageibt = (ImageButton) RootActivity.this
				.findViewById(R.id.ImageButton_loseinfo1);
		imageibt.setOnClickListener(new OnClickListener() {
	...
	public void gotolosedetailsView() {
		...
		final TextView tv1 = (TextView) RootActivity.this
				.findViewById(R.id.lose_detailTextView02);
		final TextView tv2 = (TextView) RootActivity.this
				.findViewById(R.id.lose_detailTextView04);
		final TextView tv3 = (TextView) RootActivity.this
				.findViewById(R.id.lose_detailTextView06);
		TextView tv4 = (TextView) RootActivity.this
				.findViewById(R.id.lose_detailTextView08);
		TextView tv5 = (TextView) RootActivity.this
				.findViewById(R.id.lose_detailTextView10);
		TextView tv6 = (TextView) RootActivity.this
				.findViewById(R.id.lose_detailTextView12);
		TextView tv7 = (TextView) RootActivity.this
				.findViewById(R.id.lose_detailTextView14);
		...
		ImageButton imagelose = (ImageButton) RootActivity.this
				.findViewById(R.id.details_ImageButtonlose);
		imagelose.setOnClickListener(new OnClickListener() {
		...
		// 挂失按钮的监听
		Button bt = (Button) RootActivity.this
				.findViewById(R.id.lose_details_button);
		bt.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				String sql = "insert into losebook values (" + num + ",'"
						+ losebook[0] + "','" + losebook[1] + "','" + SnameID
						+ "')";
				DBUtil.update(sql);
				Toast.makeText(RootActivity.this, "挂失成功！", Toast.LENGTH_SHORT)
						.show();
			}

		});
		// 后退按钮的设置监听
		ImageButton imageb = (ImageButton) RootActivity.this
				.findViewById(R.id.details_ImageButtonlose);
		...
		Button rt = (Button) RootActivity.this
				.findViewById(R.id.lose_return_button);
		rt.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (flag == 0) {
					Toast.makeText(RootActivity.this, "本日借阅的书籍不能当日归还",
							Toast.LENGTH_SHORT).show();
				} else if (flag == 1) {// 正常书籍可以归还
					String sql = "delete from record where B_Num='" + bookno
							+ "'";
					DBUtil.delete(sql);
					Toast.makeText(RootActivity.this, "归还成功",
							Toast.LENGTH_SHORT).show();
					gotoloseView();
				} else if (flag == -2) {
					String sql = "delete from record where B_Num='" + bookno
							+ "'";
					DBUtil.delete(sql);
					Toast.makeText(RootActivity.this, "已交过欠款，归还成功",
							Toast.LENGTH_SHORT).show();
					gotoloseView();
				} else if (flag == -1) {
					...
					String sql = "delete from record where B_Num='" + bookno
							+ "'";
					DBUtil.delete(sql);
					Toast.makeText(RootActivity.this, "您已存在欠费记录，请不要忘记补交欠费",
							Toast.LENGTH_SHORT).show();
					gotoloseView();
				}
			}
	...
	public void gotoyuyueView() {
		...
		final EditText YYSH = (EditText) RootActivity.this
				.findViewById(R.id.yuyueEditSH);
		final Button select = (Button) RootActivity.this
				.findViewById(R.id.yuyuequery01);
		// imagebutton后退按钮的监听
		ImageButton ibyuyuemain = (ImageButton) findViewById(R.id.ImageButtonyuyue);
		ibyuyuemain.setOnClickListener(new OnClickListener() {
	...
	public void gotoyuyuedetailde() {
		...
		TextView bookname = (TextView) RootActivity.this
				.findViewById(R.id.yuyuebooknametextview);
		TextView yuyueauthor = (TextView) RootActivity.this
				.findViewById(R.id.yuyuebookauthortextview);
		TextView yuyuebookpress = (TextView) RootActivity.this
				.findViewById(R.id.yuyuebookpresstextview);
		TextView yuyueborrow = (TextView) RootActivity.this
				.findViewById(R.id.yuyuebookborrowtextview);
		TextView yuyueorder = (TextView) RootActivity.this
				.findViewById(R.id.yuyuebookordertextview);
		final EditText yuyuestuno = (EditText) RootActivity.this
				.findViewById(R.id.yuyuestunumber);
		final Button borrow = (Button) RootActivity.this
				.findViewById(R.id.borrowbook);
		final Button order = (Button) RootActivity.this
		...
		ImageButton imagelose = (ImageButton) RootActivity.this
				.findViewById(R.id.ImageButtonyuyuedetails);
		imagelose.setOnClickListener(new OnClickListener() {
		...
		borrow.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (StuNO.equals("")) {
					Toast.makeText(RootActivity.this, "学号不能为空",
							Toast.LENGTH_SHORT).show();
				} else if (a >= borrowbook) {
					Toast.makeText(RootActivity.this, "已超过借阅上限，不能借阅",
							Toast.LENGTH_SHORT).show();
				} else if (temp7[4].equals("是")) {
					Toast.makeText(RootActivity.this, "此书已经借阅，不能借阅",
							Toast.LENGTH_SHORT).show();

				} else if (temp7[4].equals("否") && temp7[5].equals("是")
						&& !StuNO.equals(orderStuNO)) {
					Toast.makeText(RootActivity.this, "此书已经被预约，不能预约",
							Toast.LENGTH_SHORT).show();
				} else {
					DBUtil.borrowbook(temp[1], StuNO);
					Toast.makeText(RootActivity.this, "借阅成功",
							Toast.LENGTH_SHORT).show();
					gotoyuyueView();
				}
		...
		order.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (temp7[5].equals("否")) {
					...
					Toast.makeText(RootActivity.this, "预约成功",
							Toast.LENGTH_SHORT).show();
					gotoyuyueView();
				}
	...
	public void gotostumainView() {
		...
		final Button add = (Button) this
				.findViewById(R.id.buttonstudentmanagement_insertstu);
		final Button select = (Button) this
				.findViewById(R.id.buttonstudentmanagement_selectstu);
		...
		ibstumanagementmain.setOnClickListener(new OnClickListener() {
		...
		selectstu.setOnClickListener(new OnClickListener() {
		...
		add.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (temp2[0].equals("") || temp2[1].equals("")
						|| temp2[2].equals("") || temp2[3].equals("")
						|| temp2[4].equals("") || temp2[5].equals("")
						|| temp2[6].equals("") || temp2[7].equals("")
						|| temp2[8].equals("")) {
					Toast.makeText(RootActivity.this, "输入的信息不能为空",
							Toast.LENGTH_SHORT).show();
				} else {
					gotostuaddView();
				}
	...
	public void gotostuaddView() {
		...
		TextView tNo = (TextView) RootActivity.this
				.findViewById(R.id.stuNotextview);
		TextView tName = (TextView) RootActivity.this
				.findViewById(R.id.stunametextview);
		TextView tSex = (TextView) RootActivity.this
				.findViewById(R.id.stusextextview);
		TextView tQuanxian = (TextView) RootActivity.this
				.findViewById(R.id.stuquanxiantextview);
		TextView tAge = (TextView) RootActivity.this
				.findViewById(R.id.stuagetextview);
		TextView tTel = (TextView) RootActivity.this
				.findViewById(R.id.stuteltextview);
		TextView tClass = (TextView) RootActivity.this
				.findViewById(R.id.stuclasstextview);
		TextView tXueyuan = (TextView) RootActivity.this
				.findViewById(R.id.stuxueyuantextview);
		TextView tPwd = (TextView) RootActivity.this
				.findViewById(R.id.stupwdtextview);
		...
		ibstumanagementadd.setOnClickListener(new OnClickListener() {
		...
		bok.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				DBUtil.addStu(temp2[0], temp2[1], temp2[4], temp2[2], temp2[6],
						temp2[7], temp2[5], temp2[3], temp2[8]);
				Toast.makeText(RootActivity.this, "添加学生成功", Toast.LENGTH_SHORT)
						.show();
				gotostumainView();
			}
	...
	public void gotostuselectView() {
		...
		TextView tNo = (TextView) RootActivity.this
				.findViewById(R.id.select_stuNotextview);
		TextView tName = (TextView) RootActivity.this
				.findViewById(R.id.select_stunametextview);
		TextView tSex = (TextView) RootActivity.this
				.findViewById(R.id.select_stusextextview);
		TextView tQuanxian = (TextView) RootActivity.this
				.findViewById(R.id.select_stuquanxiantextview);
		TextView tAge = (TextView) RootActivity.this
				.findViewById(R.id.select_stuagetextview);
		TextView tTel = (TextView) RootActivity.this
				.findViewById(R.id.select_stuteltextview);
		TextView tClass = (TextView) RootActivity.this
				.findViewById(R.id.select_stuclasstextview);
		TextView tXueyuan = (TextView) RootActivity.this
				.findViewById(R.id.select_stuxueyuantextview);
		TextView tPwd = (TextView) RootActivity.this
				.findViewById(R.id.select_stupwdtextview);
		...
		ibstumanagementselect.setOnClickListener(new OnClickListener() {
		...
		delete.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Toast.makeText(RootActivity.this, "删除成功", Toast.LENGTH_SHORT)
						.show();
				gotostumainView();
			}
	...
	public void gotostumofidyView() {
		...
		final Button bok = (Button) this
				.findViewById(R.id.buttonstudentmanagement_modifystu);
		// imagebutton后退按钮的监听
		ImageButton ibstumanagementmodify = (ImageButton) findViewById(R.id.ImageButtonstudentmanagement_modify);
		ibstumanagementmodify.setOnClickListener(new OnClickListener() {
		...
		bok.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				DBUtil.updateStu(tempp, temp3[0], temp3[1], temp3[2], temp3[3],
						temp3[4], temp3[5], temp3[6], temp3[7]);
				Toast.makeText(RootActivity.this, "修改成功", Toast.LENGTH_SHORT)
						.show();
				gotostumainView();
			}
	...
	public void gotoandminmainView() {
		...
		ibadminmanagement.setOnClickListener(new OnClickListener() {
	...
	public void gotoadminaddView() {
		...
		ibaddadmin.setOnClickListener(new OnClickListener() {
		...
		addbok.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (mgNo.equals("") || mgpermitted.equals("")
						|| mgpwd.equals("")) {
					Toast.makeText(RootActivity.this, "请输入信息",
							Toast.LENGTH_SHORT).show();
				} else {
					if (DBUtil.insertManager(mgNo, mgpermitted, mgpwd)) {
						Toast.makeText(RootActivity.this, "添加管理员成功",
								Toast.LENGTH_SHORT).show();
						gotoandminmainView();
					}
				}
	...
	public void gotoandminselectView() {
		...
		TextView mgNo = (TextView) RootActivity.this
				.findViewById(R.id.adminnametextview);
		TextView permitted = (TextView) RootActivity.this
				.findViewById(R.id.adminpermittedtextview_select);
		TextView pwd = (TextView) RootActivity.this
				.findViewById(R.id.adminpasswordtextview_select);
		...
		ibadminmanagementselect.setOnClickListener(new OnClickListener() {
	...
	public void gotoandminmofidyView() {
		...
		TextView mgNo = (TextView) RootActivity.this
				.findViewById(R.id.adminnametextview_mofidy);
		TextView mgpermited = (TextView) RootActivity.this
				.findViewById(R.id.adminpermittedtextview_mofidy);
		...
		ibadminmanagementmodify.setOnClickListener(new OnClickListener() {
		...
		bok.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				if (adminnewpwd1.getText().toString().trim().equals("")
						|| adminnewpwd2.getText().toString().trim().equals("")) {
					Toast.makeText(RootActivity.this, "请输入新密码和和确认新密码",
							Toast.LENGTH_SHORT).show();
				} else {
					String oldpassword1 = adminoldpwd.getText().toString()
							.trim();
					...
					if (oldpassword2.equals(oldpassword1)) {
						...
						Toast.makeText(RootActivity.this, "修改密码成功",
								Toast.LENGTH_SHORT).show();
						gotoandminmainView();
					} else {
						Toast.makeText(RootActivity.this, "修改失败,请确定新密码和确认密码一致",
								Toast.LENGTH_SHORT).show();
	...
	public void gotoFee() {
		...
		final EditText feestuNo = (EditText) this
				.findViewById(R.id.feestudentnumberedit);
		ImageButton ibfee = (ImageButton) findViewById(R.id.ImageButtonfee1);
		ibfee.setOnClickListener(new OnClickListener() {
		...
		selectfee.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (feeStuNO.equals("")) {
					...
					if (feetodetailed.size() == 0) {
						Toast.makeText(RootActivity.this, "没有查到与你输入相关的资料！",
								Toast.LENGTH_SHORT).show();
					} else {
	...
	public void gotobookfeedetailedfrid() {
		...
		ImageButton imagefee = (ImageButton) RootActivity.this
				.findViewById(R.id.ImageButtonfeedetailed);
		imagefee.setOnClickListener(new OnClickListener() {
		...
		ibfeedatailed.setOnClickListener(new OnClickListener() {
	...
	public void gotofeexianshiView() {
		...
		TextView stuno = (TextView) RootActivity.this
				.findViewById(R.id.feebstunumber_xianshi02);
		TextView bookno = (TextView) RootActivity.this
				.findViewById(R.id.feebooknumber_xianshi02);
		TextView bookname = (TextView) RootActivity.this
				.findViewById(R.id.feebookname_xianshi02);
		TextView dalaytime = (TextView) RootActivity.this
				.findViewById(R.id.feedelaytime_xianshi02);
		TextView money = (TextView) RootActivity.this
				.findViewById(R.id.feejiaofei_xianshi02);
		...
		ImageButton imagefee = (ImageButton) RootActivity.this
				.findViewById(R.id.ImageButtonfee2);
		imagefee.setOnClickListener(new OnClickListener() {
		...
		bok.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Toast.makeText(RootActivity.this, "交费成功", Toast.LENGTH_SHORT)
						.show();
				gotoFee();
			}
...
//登录
		dlu.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (spwd.equals(ppwd)) {
					...
					Toast.makeText(RootActivity.this, "登陆失败",
							Toast.LENGTH_SHORT).show();
				}
			}
...
//重置
		chz.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				// goToMainMenu();
				yhm.setText("");
	...
	public void gotobookmanagementmainView() {
		...
		final RadioButton selectbook = (RadioButton) this
				.findViewById(R.id.radiobuttonbookmanagement_selectbook);
		final RadioButton insertbook = (RadioButton) this
				.findViewById(R.id.radiobuttonbookmanagerment_insertbook);
		...
		final Button bselectbook = (Button) this
				.findViewById(R.id.buttonbookmanagement_selectbook);
		// imagebutton后退按钮的监听
		...
		ibbookmanagmentmain.setOnClickListener(new OnClickListener() {
		...
		insertbook.setOnClickListener(new OnClickListener() {
		...
		bselectbook.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				String isbn = bookmanagementisbnEdit.getText().toString()
						.trim();

				if (isbn.equals("")) {
					Toast.makeText(RootActivity.this, "请输入要查询图书的的ISBN号",
							Toast.LENGTH_SHORT).show();
	...
	public void gotobookmanagementselectbook() {
		...
		TextView t1 = (TextView) RootActivity.this
				.findViewById(R.id.bookmanagementselect_bookisbnTextView01);// isbn
		TextView t2 = (TextView) RootActivity.this
				.findViewById(R.id.bookmanagementselect_buytimeTextView02); // buytime
		TextView t3 = (TextView) RootActivity.this
				.findViewById(R.id.bookmanagementselect_booknameTextView03);// bookname
		TextView t4 = (TextView) RootActivity.this
				.findViewById(R.id.bookmanagementselect_bookauthorTextView04);// author
		TextView t5 = (TextView) RootActivity.this
				.findViewById(R.id.bookmanagementselect_bookpressTextView05);// press
		TextView t6 = (TextView) RootActivity.this
				.findViewById(R.id.bookmanagementselect_bookintroductionTextView06);// 简介
		GridView gv = (GridView) findViewById(R.id.GridView01);
		final Button bmodifybook = (Button) this
				.findViewById(R.id.mofidybookbok);
		...
		bmodifybook.setOnClickListener(new OnClickListener() {
	...
	public void gotobookmanagemanetView() {
		...
		lst.add(ct);
		lst.add(ct1);
		ArrayAdapter<CItem> Adapter = new ArrayAdapter<CItem>(
				RootActivity.this, android.R.layout.simple_spinner_item, lst);
		...
		ImageButton imagefee = (ImageButton) RootActivity.this
				.findViewById(R.id.ImageButtonbookmanagement02);
		imagefee.setOnClickListener(new OnClickListener() {
		...
		dateEdit01.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// 年
				EditText tempyear = (EditText) dateInputdialog
						.findViewById(R.id.EditText01);
				// 月
				EditText tempmonth = (EditText) dateInputdialog
						.findViewById(R.id.EditText02);
				// 日
				EditText tempdate = (EditText) dateInputdialog
						.findViewById(R.id.EditText03);
		...
		bok.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				String id1 = ((CItem) jieyuesp.getSelectedItem()).GetID()
						.toString().trim();
				String id2 = ((CItem) yuyuesp.getSelectedItem()).GetID()
						.toString().trim();
				if (id1.equals("1")) {
					temp[5] = "是";
				} else {
	...
	public void gotobookmanagementmodifybookView() {
		...
		TextView isbn = (TextView) RootActivity.this
				.findViewById(R.id.modifybookisbnedit);
		TextView buytime = (TextView) RootActivity.this
				.findViewById(R.id.modifybookbuttimeedit);
		TextView bookname = (TextView) RootActivity.this
				.findViewById(R.id.modifybooknameedit);
		TextView bookauthor = (TextView) RootActivity.this
				.findViewById(R.id.modifybookauthoredit);
		TextView press = (TextView) RootActivity.this
				.findViewById(R.id.modifybookpressedit);
		TextView instroduction = (TextView) RootActivity.this
				.findViewById(R.id.modifybookinstroductionedit);
		...
		new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				DBUtil.updateBook(temp5[0], selectTOgird.get(0).toString(),
						selectTOgird.get(1).toString(), selectTOgird.get(2)
								.toString(), selectTOgird.get(3).toString(),
						temp5[1], temp5[2], selectTOgird.get(7).toString());
				Toast.makeText(RootActivity.this, "修改成功", Toast.LENGTH_SHORT)
						.show();
				gotobookmanagementselectbook();
			}
		...
		bdlt.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				DBUtil.deleteBook(temp5[0]);
				Toast.makeText(RootActivity.this, "信息已删除", Toast.LENGTH_SHORT)
						.show();
				gotobookmanagementselectbook();
			}

		});
		ibmodifybook.setOnClickListener(new OnClickListener() {
	...
	public void gotobookmentinsertbookxianshiView() {
		...
		TextView tisbn = (TextView) RootActivity.this
				.findViewById(R.id.insertbookisbntextview);
		TextView tbuytime = (TextView) RootActivity.this
				.findViewById(R.id.bookbuytimetextview);
		TextView tname = (TextView) RootActivity.this
				.findViewById(R.id.booknametextview);
		TextView tauthor = (TextView) RootActivity.this
				.findViewById(R.id.bookauthortextview);
		TextView tpress = (TextView) RootActivity.this
				.findViewById(R.id.bookpresstextview);
		TextView tjieyue = (TextView) RootActivity.this
				.findViewById(R.id.bookyijieyuetextview);
		TextView tyuyue = (TextView) RootActivity.this
				.findViewById(R.id.bookyiyuyuetextview);
		TextView tinstroduction = (TextView) RootActivity.this
				.findViewById(R.id.bookinstroductiontextview);
		TextView tbooknumber = (TextView) RootActivity.this
				.findViewById(R.id.booknumbertextview);
		final Button bok = (Button) this
				.findViewById(R.id.insertxianshibookbok);
		...
		ImageButton imagefee = (ImageButton) RootActivity.this
				.findViewById(R.id.ImageButtonbookmanagement04);
		imagefee.setOnClickListener(new OnClickListener() {
		...
		bok.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				DBUtil.insertBook(temp[0], temp[8], temp[3], temp[1], temp[4],
						temp[2], temp[5], temp[6], temp[7]);
				Toast.makeText(RootActivity.this, "图书入库成功", Toast.LENGTH_SHORT)
						.show();
	...
	public BaseAdapter gridView(Vector<String> v) {
		SimpleAdapter sca = new SimpleAdapter(this, generateDataList(v), // 数据List
				R.layout.grid_row, // 行对应layout id
				new String[] { "col5", "col6", "col7" }, // 列名列表
				new int[] { R.id.booknumberTextView02, R.id.jieyueTextView,
						R.id.yuyueTextView10, }// 列对应控件id列表
	...
	public BaseAdapter gridViewfee(Vector<String> v) {
		SimpleAdapter sca = new SimpleAdapter(this, generateDataListfee(v), // 数据List
				R.layout.fee_grid_row, // 行对应layout id
				new String[] { "col1", "col2", "col3" }, // 列名列表
				new int[] { R.id.booknumberTV02, R.id.booknameTV02,
						R.id.delaytiemTV02 }// 列对应控件id列表
	...
	public void gotoQueryMainView() {
		...
		// 后退按钮的设置监听
		ImageButton selfib = (ImageButton) RootActivity.this
				.findViewById(R.id.ImageButtonself_query);
		selfib.setOnClickListener(new OnClickListener() {
		...
		// 查询图书的界面
		Button selfb = (Button) RootActivity.this
				.findViewById(R.id.self_or_bok);
		selfb.setOnClickListener(new OnClickListener() {
	...
	public void gotoQueryView() {
		...
		ibquery.setOnClickListener(new OnClickListener() {
		...
		simpleq.setOnClickListener(new OnClickListener() {
		...
		// 高级单选按钮的单击监听方法
		highq.setOnClickListener(new OnClickListener() {
		...
		sbmit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (simpleq.isChecked()) {
					...
					String id = ((CItem) sp.getSelectedItem()).GetID()
							.toString().trim();

					if (result.equals("")) {
						Toast.makeText(RootActivity.this, "输入不能为空，请输入要查询的内容!",
								Toast.LENGTH_SHORT).show();
					}
					...
					resultnumdetails.clear();
					if (highSM.equals("") && highZZ.equals("")
							&& highCBS.equals("")) {
						Toast.makeText(RootActivity.this, "输入不能全为空，请输入要查询的内容!",
								Toast.LENGTH_SHORT).show();
					}
					// 书名和作者的组合查询
					else if ((!highSM.equals("")) && (!highZZ.equals(""))
							&& (highCBS.equals(""))) {
					...
					// 书名和出版社的组合查询
							...
							&& (!highCBS.equals(""))) {
						queryTOgird = DBUtil
								.getBnCbAllfrombook(highSM, highCBS);
						toast(queryTOgird, resultnumdetails);
					}
					// 作者和出版社的组合查询
					else if ((highSM.equals("")) && (!highZZ.equals(""))
							&& (!highCBS.equals(""))) {
						queryTOgird = DBUtil
								.getAuCbAllfrombook(highZZ, highCBS);
						toast(queryTOgird, resultnumdetails);
					}
					// 书名作者出版社三者的组合查询
					else if ((!highSM.equals("")) && (!highZZ.equals(""))
							&& (!highCBS.equals(""))) {
						queryTOgird = DBUtil.getBnAuCbAllfrombook(highSM,
								highZZ, highCBS);
						toast(queryTOgird, resultnumdetails);
					} else {
						Toast.makeText(RootActivity.this,
								"输入最多一个为空，请输入要查询的内容!", Toast.LENGTH_SHORT)
								.show();
					}
				}
			}
	...
	public void gotogirdView() {
		...
		gv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {// 重写选项被单击事件的处理方法
				// TextView
				// tv=(TextView)findViewById(R.id.girdTextView);//获取主界面TextView
				LinearLayout ll = (LinearLayout) arg1;// 获取当前选中选项对应的LinearLayout
				LinearLayout l2 = (LinearLayout) ll.getChildAt(0);
		...
		ImageButton gridButtonback = (ImageButton) RootActivity.this
				.findViewById(R.id.ImageButtonquery_qrid01);
		gridButtonback.setOnClickListener(new OnClickListener() {
	...
	public void gotodetaislView() {
		...
		TextView t1 = (TextView) RootActivity.this
				.findViewById(R.id.TextViewdetails01);
		TextView t2 = (TextView) RootActivity.this
				.findViewById(R.id.TextViewdetails02);
		TextView t3 = (TextView) RootActivity.this
				.findViewById(R.id.TextViewdetails03);
		TextView t4 = (TextView) RootActivity.this
				.findViewById(R.id.TextViewdetails04);
		TextView t5 = (TextView) RootActivity.this
				.findViewById(R.id.TextViewdetails05);
		TextView t6 = (TextView) RootActivity.this
				.findViewById(R.id.TextViewdetails06);
		...
		Vector<String> bookdetails = DBUtil
				.selectISBNALlfromdetailInfo(BookISBNgirdTOdetails);
		...
		// 设置后退按钮的监听
		ImageButton detailsButtonback = (ImageButton) RootActivity.this
				.findViewById(R.id.ImageButtonquery_details01);
		detailsButtonback.setOnClickListener(new OnClickListener() {
	...
	public List<? extends Map<String, ?>> generateDataList1(Vector<String> v,
			Vector<String> vv) {
		ArrayList<Map<String, Object>> list = new ArrayList<Map<String, Object>>();
		;
	...
	public BaseAdapter selfgridView(Vector<String> v) {
		SimpleAdapter sca = new SimpleAdapter(this,
				...
				new String[] { "col1", "col2", "col3", "col4", "col5", "col6",
						"col7" }, // 列名列表
				new int[] { R.id.self_detailTextView02,
						R.id.self_detailTextView04, R.id.self_detailTextView06,
						R.id.self_detailTextView08, R.id.self_detailTextView10,
						R.id.self_detailTextView12, R.id.self_detailTextView14 }// 列对应控件id列表
		);
		return sca;
	...
	public BaseAdapter gridView1(Vector<String> v, Vector<String> vv) {
		SimpleAdapter sca = new SimpleAdapter(this, generateDataList1(v, vv), // 数据List
				R.layout.details_grid_row, // 行对应layout id
				new String[] { "col1", "col2", "col3" }, // 列名列表
				new int[] { R.id.TextViewdetail01, R.id.TextViewdetail02,
						R.id.TextViewdetail03 }// 列对应控件id列表
		);
		return sca;
		// gv.setAdapter(sca);//为GridView设置数据适配器
	}
	...
	public BaseAdapter gridView(Vector<String> v, Vector<Integer> result) {
		SimpleAdapter sca = new SimpleAdapter(this,
				...
				new String[] { "col1", "col2", "col3", "col4", "col5" }, // 列名列表
				new int[] { R.id.TextView02, R.id.TextView04, R.id.TextView06,
						R.id.TextView08, R.id.TextView10 }// 列对应控件id列表
		);
		return sca;
		// gv.setAdapter(sca);//为GridView设置数据适配器
	}
	...
	public void toast() {
		Toast.makeText(RootActivity.this, "没有查到与你输入相关的资料！", Toast.LENGTH_SHORT)
				.show();
	}
	...
	public void toast(Vector<String> v, Vector<Integer> vv) {
		if (v.size() == 0) {
			...
			for (int i = 0; i < v.size() / 4; i++) {
				vv.add(DBUtil.getNumfrombdetailedInfo(v.get(i * 4).toString()
						.trim()));
			}
			gotogirdView();
		}
